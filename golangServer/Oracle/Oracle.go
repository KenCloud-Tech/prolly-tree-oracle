...
func (_Oracle *OracleTransactor) Search(opts *bind.TransactOpts, cid string, colName string, querys []byte, callBack string) (*types.Transaction, error) {
	return _Oracle.contract.Transact(opts, "Search", cid, colName, querys, callBack)
}

// Search is a paid mutator transaction binding the contract method 0x38ae4ea1.
//
// Solidity: function Search(string cid, string colName, bytes querys, string callBack) returns()
func (_Oracle *OracleSession) Search(cid string, colName string, querys []byte, callBack string) (*types.Transaction, error) {
	return _Oracle.Contract.Search(&_Oracle.TransactOpts, cid, colName, querys, callBack)
}

// Search is a paid mutator transaction binding the contract method 0x38ae4ea1.
//
// Solidity: function Search(string cid, string colName, bytes querys, string callBack) returns()
func (_Oracle *OracleTransactorSession) Search(cid string, colName string, querys []byte, callBack string) (*types.Transaction, error) {
	return _Oracle.Contract.Search(&_Oracle.TransactOpts, cid, colName, querys, callBack)
}
...
//
// Solidity: event search(uint256 reqID, string cid, string colName, bytes querys, string callBack, address sender)
