...
//
// Solidity: function Get(string dbName, bytes recordID, string callBack) returns(uint256 reqID)
...
//
// Solidity: function Index(string dbName, string Key) returns(uint256 reqID)
...
//
// Solidity: function Search(string dbName, (string,string,int64,uint64,bytes,bool,string,string,string) Val, string Method, string callBack) returns(uint256 reqID)
...
// FilterSearch is a free log retrieval operation binding the contract event 0xd9e9b51bcc51c5cf856096d701fea36711ae739f84dd4da0c06940e3b6640808.
//
// Solidity: event search(uint256 reqID, string dbName, (string,string,int64,uint64,bytes,bool,string,string,string) Val, string Method, string callBack, address sender)
...
// WatchSearch is a free log subscription operation binding the contract event 0xd9e9b51bcc51c5cf856096d701fea36711ae739f84dd4da0c06940e3b6640808.
//
// Solidity: event search(uint256 reqID, string dbName, (string,string,int64,uint64,bytes,bool,string,string,string) Val, string Method, string callBack, address sender)
...
// ParseSearch is a log parse operation binding the contract event 0xd9e9b51bcc51c5cf856096d701fea36711ae739f84dd4da0c06940e3b6640808.
//
// Solidity: event search(uint256 reqID, string dbName, (string,string,int64,uint64,bytes,bool,string,string,string) Val, string Method, string callBack, address sender)
