...
// GasPerByteByUrl is a free data retrieval call binding the contract method 0xc03431cd.
//
// Solidity: function gasPerByteByUrl() view returns(uint256)
func (_Oracle *OracleCaller) GasPerByteByUrl(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Oracle.contract.Call(opts, &out, "gasPerByteByUrl")
...
//
// Solidity: function gasPerByteByUrl() view returns(uint256)
func (_Oracle *OracleSession) GasPerByteByUrl() (*big.Int, error) {
	return _Oracle.Contract.GasPerByteByUrl(&_Oracle.CallOpts)
}

// GasPerByteByUrl is a free data retrieval call binding the contract method 0xc03431cd.
//
// Solidity: function gasPerByteByUrl() view returns(uint256)
func (_Oracle *OracleCallerSession) GasPerByteByUrl() (*big.Int, error) {
	return _Oracle.Contract.GasPerByteByUrl(&_Oracle.CallOpts)
}
...
//
// Solidity: function AllowWrite(string dbName, address to) payable returns()
...
// ImportFromUrlRsp is a paid mutator transaction binding the contract method 0xfb6d3cab.
//
// Solidity: function Import_from_url_Rsp(uint256 reqID, bool statement, uint256 size, address sender, string info) returns()
func (_Oracle *OracleTransactor) ImportFromUrlRsp(opts *bind.TransactOpts, reqID *big.Int, statement bool, size *big.Int, sender common.Address, info string) (*types.Transaction, error) {
	return _Oracle.contract.Transact(opts, "Import_from_url_Rsp", reqID, statement, size, sender, info)
}

// ImportFromUrlRsp is a paid mutator transaction binding the contract method 0xfb6d3cab.
//
// Solidity: function Import_from_url_Rsp(uint256 reqID, bool statement, uint256 size, address sender, string info) returns()
func (_Oracle *OracleSession) ImportFromUrlRsp(reqID *big.Int, statement bool, size *big.Int, sender common.Address, info string) (*types.Transaction, error) {
	return _Oracle.Contract.ImportFromUrlRsp(&_Oracle.TransactOpts, reqID, statement, size, sender, info)
}

// ImportFromUrlRsp is a paid mutator transaction binding the contract method 0xfb6d3cab.
//
// Solidity: function Import_from_url_Rsp(uint256 reqID, bool statement, uint256 size, address sender, string info) returns()
func (_Oracle *OracleTransactorSession) ImportFromUrlRsp(reqID *big.Int, statement bool, size *big.Int, sender common.Address, info string) (*types.Transaction, error) {
	return _Oracle.Contract.ImportFromUrlRsp(&_Oracle.TransactOpts, reqID, statement, size, sender, info)
}
...
// FilterImportFromUrl is a free log retrieval operation binding the contract event 0x02eddedb9ac9f80f9cd1d86b5aa310afd7087435881e0b78c24e5a93547db18e.
//
// Solidity: event import_from_url(uint256 reqID, string dbName, string colName, string url, uint256 value, string format, address sender)
...
// WatchImportFromUrl is a free log subscription operation binding the contract event 0x02eddedb9ac9f80f9cd1d86b5aa310afd7087435881e0b78c24e5a93547db18e.
//
// Solidity: event import_from_url(uint256 reqID, string dbName, string colName, string url, uint256 value, string format, address sender)
...
// ParseImportFromUrl is a log parse operation binding the contract event 0x02eddedb9ac9f80f9cd1d86b5aa310afd7087435881e0b78c24e5a93547db18e.
//
// Solidity: event import_from_url(uint256 reqID, string dbName, string colName, string url, uint256 value, string format, address sender)
